...
?>
<?php
//* Pas de $user->getPssword() le password ne doit pas etre en placeholder
// dump($_POST);
?>
...
<div class="container my-4">
    ...
    <h3>
        <ul>
            <!-- Boucle sur $errors, array d'erreurs transmis par show() -->
            <!-- Vérifier que $errors existe
                 if (isset($errors)) 
    ...
    <form action="" method="POST" class="mt-5">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Nom de l'utilisateur" value="<?= $user->getLastName() ?>" required>
        </div>
        <div class="mb-3">
